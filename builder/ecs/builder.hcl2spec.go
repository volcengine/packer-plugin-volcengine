...
type FlatConfig struct {
	...
	TargetImageName           *string                        `mapstructure:"target_image_name" required:"true" cty:"target_image_name" hcl:"target_image_name"`
	SystemDiskType            *string                        `mapstructure:"system_disk_type" required:"true" cty:"system_disk_type" hcl:"system_disk_type"`
	SystemDiskSize            *int32                         `mapstructure:"system_disk_size" required:"true" cty:"system_disk_size" hcl:"system_disk_size"`
	DataDisks                 []FlatVolcengineDataDiskConfig `mapstructure:"data_disks" required:"false" cty:"data_disks" hcl:"data_disks"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"target_image_name":            &hcldec.AttrSpec{Name: "target_image_name", Type: cty.String, Required: false},
		...
		"data_disks":                   &hcldec.BlockListSpec{TypeName: "data_disks", Nested: hcldec.ObjectSpec((*FlatVolcengineDataDiskConfig)(nil).HCL2Spec())},
...
// FlatVolcengineDataDiskConfig is an auto-generated flat version of VolcengineDataDiskConfig.
// Where the contents of a field with a `mapstructure:,squash` tag are bubbled up.
type FlatVolcengineDataDiskConfig struct {
	DataDiskType *string `mapstructure:"data_disk_type" required:"true" cty:"data_disk_type" hcl:"data_disk_type"`
	DataDiskSize *int32  `mapstructure:"data_disk_size" required:"true" cty:"data_disk_size" hcl:"data_disk_size"`
}

// FlatMapstructure returns a new FlatVolcengineDataDiskConfig.
// FlatVolcengineDataDiskConfig is an auto-generated flat version of VolcengineDataDiskConfig.
// Where the contents a fields with a `mapstructure:,squash` tag are bubbled up.
func (*VolcengineDataDiskConfig) FlatMapstructure() interface{ HCL2Spec() map[string]hcldec.Spec } {
	return new(FlatVolcengineDataDiskConfig)
}

// HCL2Spec returns the hcl spec of a VolcengineDataDiskConfig.
// This spec is used by HCL to read the fields of VolcengineDataDiskConfig.
// The decoded values from this spec will then be applied to a FlatVolcengineDataDiskConfig.
func (*FlatVolcengineDataDiskConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
